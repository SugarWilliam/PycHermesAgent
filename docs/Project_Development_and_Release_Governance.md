...
**Phase 1 (engineering preview) roadmap exit** is **closed** per `docs/architecture/Phase1_Roadmap_v0.2.0.md` §10; **production** readiness remains blocked on semantic MRAG, desktop packaging, migrations, observability, and install verification as stated below.
