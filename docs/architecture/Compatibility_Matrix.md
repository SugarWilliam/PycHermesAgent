...
| `sidecar_api_version` | `0.3` | Adds `GET /runtime-paths` (writable layout snapshot for shells and ops); includes `0.2` routes (`GET /assets`, `/artifacts`, MRAG ingest, error domains, etc.) |
